...
# value 32'hA.
add wave -noupdate -divider {mux32t1}
add wave -noupdate -divider {input}
add wave -noupdate -label i_D /tb_mux32t1/s_D
add wave -noupdate -label i_S -radix unsigned /tb_mux32t1/s_S

add wave -noupdate -divider {output}
add wave -noupdate -label o_O /tb_mux32t1/s_O
